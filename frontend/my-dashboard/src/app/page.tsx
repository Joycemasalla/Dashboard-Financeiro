// src/app/page.tsx
import type { Metadata, Viewport } from "next"; // Adicionado para manter as tipagens
...
export default async function DashboardPage({
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* WhatsApp Float Button - AGORA USANDO CLASSES PADRONIZADAS */}
      <a
        href={whatsappLink}
        target="_blank"
        rel="noopener noreferrer"
        // Usando as novas classes definidas em globals.css para estilo e posição
        className="floating-button-base floating-button-whatsapp shadow-2xl group"
      ...
      >
        ...
        {/* Tooltip agora posicionado relativo ao FAB. Adicionamos 'group' ao FAB para o hover funcionar */}
        <div className="absolute bottom-16 right-0 bg-gray-900/95 backdrop-blur-sm text-white text-xs px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap border border-gray-700/50 shadow-lg pointer-events-none">
          💬 Suporte WhatsApp
        </div>
      </a>
