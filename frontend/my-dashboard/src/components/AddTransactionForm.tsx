          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                // CORREÇÃO: Aumentado o pl de 16 para 20 para garantir que o 'R$' não sobreponha o texto
                className="w-full pl-20 pr-4 py-4 bg-gray-800/60 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg font-semibold"
                required
                disabled={isLoading}
                inputMode="decimal"
              />
